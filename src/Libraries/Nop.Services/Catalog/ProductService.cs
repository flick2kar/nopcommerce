    ...
    public partial class ProductService : IProductService
    {
            ...
            bool? overridePublished = null)
        {
            ...
            return SearchProducts(out filterableSpecificationAttributeOptionIds, false,
                ...
                priceMin, priceMax, productTagId, keywords, searchDescriptions, searchManufacturerPartNumber, searchManufacturers, searchSku,
            ...
            bool? overridePublished = null)
        {
            ...
            if (_commonSettings.UseStoredProceduresIfSupported && _dataProvider.StoredProceduredSupported)
            {
                ...
                var pSearchManufactures = _dataProvider.GetParameter();
                pSearchManufactures.ParameterName = "SearchManufactures";
                pSearchManufactures.Value = searchManufacturers;
                pSearchManufactures.DbType = DbType.Boolean;
